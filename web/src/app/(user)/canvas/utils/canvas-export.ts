...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = APP_NAME) {
    ...
    const data: CanvasExportFile = { app: "aicanvas", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
