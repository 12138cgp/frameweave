...
import { Check, Lock, LockOpen, X } from "@/components/icons";
...
export function CanvasNodeCropDialog({ dataUrl, open, onClose, onConfirm }: { dataUrl: string; open: boolean; onClose: () => void; onConfirm: (crop: CanvasImageCropRect) => void }) {
    ...
    return (
        <Modal title={<span className="font-heading font-medium tracking-wide">裁剪图片</span>} open={open && Boolean(dataUrl)} onCancel={onClose} footer={null} width={780} centered destroyOnHidden>
