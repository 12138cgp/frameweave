    ...
    return (
        <Modal title={null} open={open && Boolean(dataUrl)} onCancel={onClose} footer={null} width={820} centered destroyOnHidden>
            <div className="space-y-5">
                <div>
                    <h2 className="font-heading text-xl font-medium tracking-wide">图片放大</h2>
                </div>
                <div className="grid gap-6 md:grid-cols-[minmax(260px,1fr)_360px]">
                    <div className="rounded-xl border p-4">
                        <div className="grid min-h-[280px] place-items-center rounded-lg bg-[#0F172A]/[0.04] dark:bg-[#E2E8F0]/[0.05]">
                    ...
                    <div className="space-y-6 py-2">
                        <div className="space-y-2">
                            ...
                            />
                            {image && !canUpscale ? <div className="text-xs font-medium text-[#DC2626] dark:text-[#EF4444]">{reachedMax ? "图片已达到 4K，无需放大" : "图片已达到当前目标像素，无需放大"}</div> : null}
                        </div>
                        <div className="space-y-2">
