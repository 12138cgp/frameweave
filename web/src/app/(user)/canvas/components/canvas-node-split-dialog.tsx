...
const defaultParams: CanvasImageSplitParams = { rows: 3, columns: 3 };
    ...
    return (
        <Modal title={null} open={open && Boolean(dataUrl)} onCancel={onClose} footer={null} width={780} centered destroyOnHidden>
            <div className="space-y-5">
                <div>
                    <h2 className="font-heading text-xl font-medium tracking-wide">切分图片</h2>
                ...
                <div className="grid gap-6 md:grid-cols-[minmax(260px,1fr)_280px]">
                    <div className="rounded-xl border p-4">
                        <div className="grid min-h-[300px] place-items-center rounded-lg bg-[#0F172A]/[0.04] dark:bg-[#E2E8F0]/[0.05]">
